...
| "has my team moved", "migration status context" | [src/context/MigrationStatusContext.jsx](src/context/MigrationStatusContext.jsx) (fetches `GET /migration/me` once per user; fails open) + [src/utils/migrationDestination.js](src/utils/migrationDestination.js) (`V2_APP_URL`, `shouldShowMovedInterstitial`, `shouldShowMovedBanner`) |
