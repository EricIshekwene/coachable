...
import AdminPlayEditPage from "./pages/admin/AdminPlayEditPage";
import AdminPresetEditPage from "./pages/admin/AdminPresetEditPage";
import AdminSportPresetsPage from "./pages/admin/AdminSportPresetsPage";
import AdminSportPrefabPresetsPage from "./pages/admin/AdminSportPrefabPresetsPage";
import AdminPrefabPresetEditPage from "./pages/admin/AdminPrefabPresetEditPage";
import AdminPlaysPage from "./pages/admin/AdminPlaysPage";
...
import AdminMobileView from "./pages/admin/AdminMobileView";
import AdminTestSlate from "./pages/admin/AdminTestSlate";
import AdminGIFTest from "./pages/admin/AdminGIFTest";
import AdminDemoVideos from "./pages/admin/AdminDemoVideos";
import AdminOnePage from "./pages/admin/AdminOnePage";
...
import PublicPlaybooksPage from "./pages/public/PublicPlaybooksPage";
