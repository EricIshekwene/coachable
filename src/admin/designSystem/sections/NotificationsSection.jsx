...
import { AdminNotificationItem } from "../../../admin/components";
...
export default function NotificationsSection() {
  return (
    <div className="flex flex-col gap-10">
      ...
      <DSGroup title="Notification bell + items" status="live" description="AdminNotificationItem: read/unread states with accent dot and tinted background.">
        <DSTile>
          <div className="mx-auto max-w-sm overflow-hidden rounded-xl" style={{ backgroundColor: "var(--adm-surface-elevated)", border: "1px solid var(--adm-border2)", boxShadow: "var(--adm-shadow)" }}>
            ...
            <AdminNotificationItem title='Maya shared "Trips Right Flood"' time="2m ago" read={false} />
            <AdminNotificationItem title="New join request for Austin Arrows" time="1h ago" read={false} />
            <AdminNotificationItem title="Your play was added to a playbook" time="Yesterday" read={true} />
          </div>
        </DSTile>
      </DSGroup>
