            ...
            >
                ...
                <div className="flex flex-col pb-2 sm:pb-3">
                    <button
                        ...
                        className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg w-full bg-BrandGray2/20 border border-BrandGray2/40 opacity-60 cursor-not-allowed"
                        aria-label="Record Mode coming soon"
                    >
                        <span className="text-xs font-DmSans font-medium text-BrandGray">
                            Record Mode
                        </span>
                    </button>
                ...
                <div className="flex flex-col pb-2 sm:pb-3 md:pb-4 items-start justify-center gap-1 sm:gap-2">
                    ...
                    >
                        <FiUpload className="text-BrandOrange text-sm shrink-0" aria-hidden />
                ...
                <LoggerSettingsSection
                    ...
                    onCopyGifExportDebug={onCopyGifExportDebug}
