    ...
    return (
      <div className="mx-auto max-w-3xl px-6 py-8 md:px-10 md:py-12">
        <button
          ...
          className="mb-8 flex items-center gap-2 text-sm text-[#9AA0A6] transition hover:text-BrandText"
        >
          Back to Playbook
        </button>
        <h1 className="font-Manrope text-xl font-bold tracking-tight">Play not found</h1>
        <p className="mt-2 text-sm text-[#9AA0A6]">The play you're looking for doesn't exist.</p>
      </div>
    );
  }
