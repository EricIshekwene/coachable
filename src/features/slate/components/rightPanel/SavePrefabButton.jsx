  ...
  return (
    <div className="w-full py-1 sm:py-1.5 md:py-2 border-b border-BrandGray2 pb-2 sm:pb-3 md:pb-4">
      <button
        ...
        className="w-full flex flex-col justify-center bg-BrandBlack2 py-2 sm:py-2.5 px-2 sm:px-2.5 md:px-3 rounded-md items-center gap-1 sm:gap-1.5 cursor-pointer hover:bg-BrandBlack transition-colors duration-200"
      >
