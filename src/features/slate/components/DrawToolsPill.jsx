...
export default function DrawToolsPill({ activeSubTool, onSubToolChange, onClose }) {
  return (
    ...
    <div
      ...
      className="flex items-center gap-1 select-none rounded-full border border-white/10 bg-[rgba(18,18,18,0.92)] px-1.5 py-1.5 shadow-[0_1px_4px_rgba(0,0,0,0.08)] backdrop-blur-sm"
    >
