 ...
 *
 * Default environment is 'node' (matching the existing test-harness/test/ suite).
 * Individual test files that need jsdom declare it via a file-level docblock:
 *   // @vitest-environment jsdom
 * This is the same pattern used by test-harness/test/notificationsRetry.test.js.
 *
...
export default mergeConfig(viteConfig, defineConfig({
  test: {
     ...
     * Existing test-harness/test/ files that import explicitly from 'vitest' are
